...
/*
* adding germplasm_par*_type for the sample out file
*/

--changeset raza:add_par_type_for_sample context:general splitStatements:false
...
RETURNS TABLE(dnarun_name text
		...
		, germplasm_par1 text
		, germplasm_par1_type text
		, germplasm_par2 text
		, germplasm_par2_type text
		, germplasm_par3 text
		, germplasm_par3_type text
		, germplasm_par4 text
		, germplasm_par4_type text
  ...
  BEGIN
        ...
        select * from (
                select distinct on (dl.ds_id, dr.dataset_dnarun_idx->>dl.ds_id::text) dl.ds_id as did, (dr.dataset_dnarun_idx->>dl.ds_id::text)::integer as ds_idx
                        ...
                        ,(p.props->>getPropertyIdByNamesAndType('germplasm_prop','par1',1)::text)
                        ,(p.props->>getPropertyIdByNamesAndType('germplasm_prop','par1_type',1)::text)
                        ,(p.props->>getPropertyIdByNamesAndType('germplasm_prop','par2',1)::text)
                        ,(p.props->>getPropertyIdByNamesAndType('germplasm_prop','par2_type',1)::text)
                        ,(p.props->>getPropertyIdByNamesAndType('germplasm_prop','par3',1)::text)
                        ,(p.props->>getPropertyIdByNamesAndType('germplasm_prop','par3_type',1)::text)
                        ,(p.props->>getPropertyIdByNamesAndType('germplasm_prop','par4',1)::text)
                        ,(p.props->>getPropertyIdByNamesAndType('germplasm_prop','par4_type',1)::text)
...
CREATE OR REPLACE FUNCTION getSampleQCMetadataByMarkerList(markerlist text)
 RETURNS TABLE(dnarun_name text
  ...
  BEGIN
        ...
        select t.dnarun_name, t.dnarun_barcode, t.project_name, t.project_pi_contact, t.project_genotyping_purpose, t.project_date_sampled, t.project_division, t.project_study_name, t.experiment_name, t.vp_name, t.v_name, t.pr_name, t.dataset_name, t.germplasm_name, t.exc, t.species, t.type  , t.gid, t.gssd, t.gs, t.ghg, t.gp1,t.gpt1, t.gp2,t.gpt2, t.gp3,t.gpt3, t.gp4,t.gpt4, t.gped, t.dnasample_name, t.plate, t.dnum, t.wr, t.wc, t.dtn, t.dsg, t.dsgc, t.dst, t.dsp, t.drs
        from (
                select distinct on (dl.ds_id, dr.dataset_dnarun_idx->>dl.ds_id::text)
                        dl.ds_id as did
                        ,(dr.dataset_dnarun_idx->>dl.ds_id::text)::integer as ds_idx
