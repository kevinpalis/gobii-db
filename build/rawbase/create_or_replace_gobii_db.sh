...
#This is a utility script mainly used for automation in Bamboo. This creates a fresh database and initializes the crop schema on it.
#Sample Bamboo call: sh create_or_replace_gobii_db.sh ${bamboo.crop.db.name} ${bamboo.db.username} ${bamboo.db.container.name} ${bamboo.db.port} ${bamboo.db.password}
