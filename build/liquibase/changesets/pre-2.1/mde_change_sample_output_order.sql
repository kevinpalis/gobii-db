...
/*
* changing the sameple output file data,moving  germplasm_name, germplasm_pedigree & germplasm_type to 2nd,3rd &4th position.
*/

--changeset raza:change_output_order_sample context:general splitStatements:false
