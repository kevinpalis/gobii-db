...
DROP FUNCTION IF EXISTS createMarker(platformid integer, variantid integer, markername text, markercode text, markerref text, markeralts text[], markersequence text, referenceid integer, markerprimers jsonb, markerprobsets text[], strandid integer, markerstatus integer);
DROP FUNCTION IF EXISTS updateMarker(id integer, platformid integer, variantid integer, markername text, markercode text, markerref text, markeralts text[], markersequence text, referenceid integer, markerprimers jsonb, markerprobsets text[], strandid integer, markerstatus integer);

--changeset kpalis:fix_upsertmapsetpropertybyname context:general splitStatements:false
DROP FUNCTION IF EXISTS upsertmapsetpropertybyname(id integer, propertyname text, propertyvalue text);
